	...
	<div class="content row" >
		...
		<div class="col-md-2 sidebar box">
			<div class="nav-side-menu">
				...
				<div class="menu-list">
					<form id="MainMenu" method="post" action="<?php echo base_url()."can_ho/can_ho1" ; ?>">
								...
								<ul class="sub-menu <?php if($provinceID == $provinceObj->PROVINCEID) echo "collapsed"; else echo "collapse"; ?>" id="<?php echo $x ?>">
									<?php foreach($listDistrict as $districtObj):  ?>
										<?php if($districtObj->PROVINCEID == $provinceObj->PROVINCEID): ?>
											<li class="<?php if($districtID == $districtObj->DISTRICTID) echo "active"; ?>"><a href="<?php echo base_url()."can_ho/can_ho_cho_thue1/".$provinceObj->PROVINCEID."/".$districtObj->DISTRICTID ; ?>"><?php echo $districtObj->DISTRICTNAME ; ?></a></li>
										<?php endif; ?>
									<?php endforeach; ?>
								</ul>
							<?php endforeach; ?>
		...
		<div class="col-md-8">
			<form id="tab1" action="<?php echo base_url(); ?>can_ho/can_ho_cho_thue" method="POST">
			</form>
			<form id="tab2" action="<?php echo base_url(); ?>can_ho/can_ho_can_ban" method="POST">
			</form>

			<ul class="nav nav-tabs" role="tablist" id="myTab">
				<li role="presentation" <?php if ($hinhthuc == "can_ho_cho_thue") echo "class='active'" ; ?>  > 
					<a id="contenttab1" href="#hostelRentTab" aria-controls="home" role="tab" data-toggle="tab">Căn hộ cho thuê</a>
				</li>
				<li role="presentation" <?php if ($hinhthuc == "can_ho_can_ban") echo "class='active'" ; ?> > 
					<a id="contenttab2" href="#hostelFindPartnerTab" aria-controls="profile" role="tab" data-toggle="tab">Căn hộ cần bán</a>
				</li>
			</ul>

			<div class="tab-content">

				<div role="tabpanel" class="tab-pane <?php if ($hinhthuc == 'can_ho_cho_thue') echo 'active'; ?>" id="hostelRentTab">
				...
				<div role="tabpanel" class="tab-pane <?php if ($hinhthuc == 'can_ho_can_ban') echo 'active'; ?>" id="hostelFindPartnerTab" >
