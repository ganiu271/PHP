			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>admin/add_account">Add Account</a>
						</li>
					</ul>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="<?php echo base_url(); ?>admin/new_account" method="post" class="form-horizontal">
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Username</label>
											<div class="col-md-4" id="divuser">
												<input type="text" class="form-control input-circle" placeholder="Enter text" id="username" name="username" required>
												<span style="font-weight:bold;" class='help-block' id="userstt">
												</span>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												...
												<span style="font-weight:bold;" class='help-block' id="pwstt">
													</span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-4">
												<div class="input-group">
													...
													<input type="email" class="form-control input-circle-right" name="email" placeholder="Email Address">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" class="form-control input-circle" placeholder="Enter text" name="fullname">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-4 radio-list">
												<label class="radio-inline">
													<span class="checked">
														<input type="radio" name="sex" id="optionsRadios4" value="Male" checked="">
													</span>
													Male
												</label>
												<label class="radio-inline">
													<span>
														<input type="radio" name="sex" id="optionsRadios5" value="Female">
													</span>
													Female
												</label>
											</div>
