	...
	<div class="content row" >
		...
		<div class="col-md-2 sidebar box">
			<div class="nav-side-menu">
				...
				<div class="menu-list">
					<form id="MainMenu" method="post" action="<?php echo base_url()."nha_dat/nha_dat1" ; ?>">
								...
								<ul class="sub-menu <?php if($provinceID == $provinceObj->PROVINCEID) echo "collapsed"; else echo "collapse"; ?>" id="<?php echo $x ?>">
									<?php foreach($listDistrict as $districtObj):  ?>
										<?php if($districtObj->PROVINCEID == $provinceObj->PROVINCEID): ?>
											<li class="<?php if($districtID == $districtObj->DISTRICTID) echo "active"; ?>"><a href="<?php echo base_url()."nha_dat/nha_cho_thue1/".$provinceObj->PROVINCEID."/".$districtObj->DISTRICTID ; ?>"><?php echo $districtObj->DISTRICTNAME ; ?></a></li>
										<?php endif; ?>
									<?php endforeach; ?>
								</ul>
							<?php endforeach; ?>
		...
		<div class="col-md-8">
			<form id="tab1" action="<?php echo base_url(); ?>nha_dat/nha_cho_thue" method="POST">
			</form>
			<form id="tab2" action="<?php echo base_url(); ?>nha_dat/nha_dat_can_ban" method="POST">
			</form>


			<ul class="nav nav-tabs" role="tablist" id="myTab">
				<li role="presentation" <?php if ($hinhthuc == "nha_cho_thue") echo "class='active'" ; ?>  > 
					<a id="contenttab1" href="#hostelRentTab" aria-controls="home" role="tab" data-toggle="tab">Nhà cho thuê</a>
				</li>
				<li role="presentation" <?php if ($hinhthuc == "nha_dat_can_ban") echo "class='active'" ; ?> > 
					<a id="contenttab2" href="#hostelFindPartnerTab" aria-controls="profile" role="tab" data-toggle="tab">Nhà đất cần bán</a>
				</li>
			</ul>

			<div class="tab-content">

				<div role="tabpanel" class="tab-pane <?php if ($hinhthuc == 'nha_cho_thue') echo 'active'; ?>" id="hostelRentTab">
				...
				<div role="tabpanel" class="tab-pane <?php if ($hinhthuc == 'nha_dat_can_ban') echo 'active'; ?>" id="hostelFindPartnerTab" >
